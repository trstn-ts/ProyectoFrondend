...
function Areas() {
  ...
  const verUsuarios = async (area) => {
    ...
    try {
      const res = await fetch(
        `https://webback-production-7ccc.up.railway.app//web/areasUsuarios?id_area=${area.id_area}`
      );
  ...
  const eliminarArea = async (id_area) => {
    ...
    try {
      const res = await fetch(
        `https://webback-production-7ccc.up.railway.app//web/areas/${id_area}`,
        { method: "DELETE" }
      );
  ...
  const guardarArea = async (e) => {
    ...
    try {
      const res = await fetch("https://webback-production-7ccc.up.railway.app//web/areaNuevo", {
        method: "POST",
      ...
      if (data.success) {
        ...
        const resAreas = await fetch("https://webback-production-7ccc.up.railway.app//web/areas");
