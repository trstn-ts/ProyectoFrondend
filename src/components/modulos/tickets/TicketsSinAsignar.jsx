...
function Tickets() {
  ...
  useEffect(() => {
    const obtenerTickets = async () => {
      try {
        const respuesta = await fetch("https://webback-production-7ccc.up.railway.app/web/ticketsSinAsignar");
  ...
  useEffect(() => {
    const obtenerTecnicos = async () => {
      try {
        const res = await fetch("https://webback-production-7ccc.up.railway.app/web/tecnicos");
  ...
  const asignarTicket = async () => {
    ...
    try {
      const respuesta = await fetch("https://webback-production-7ccc.up.railway.app/web/asignarTicket", {
        method: "PUT",
