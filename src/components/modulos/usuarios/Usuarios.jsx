...
function Usuarios() {
  ...
  useEffect(() => {
    const obtenerUsuarios = async () => {
      try {
        const res = await fetch("https://proyectobackend-production-f34d.up.railway.app/web/usuarios");
  ...
  useEffect(() => {
    const cargarRoles = async () => {
      try {
        const res = await fetch("https://proyectobackend-production-f34d.up.railway.app/web/roles");
        const datos = await res.json();
        setRoles(datos);
      } catch (err) {
  ...
  const guardarUsuario = async (e) => {
    ...
    try {
      const res = await fetch("https://proyectobackend-production-f34d.up.railway.app/web/usuariosNuevo", {
        method: "POST",
      ...
      if (data.success) {
        ...
        const resUsuarios = await fetch("https://proyectobackend-production-f34d.up.railway.app/web/usuarios");
  ...
  const guardarEdicion = async (e) => {
    ...
    try {
      const res = await fetch(`https://proyectobackend-production-f34d.up.railway.app/web/usuariosActualizar/${id_usuario}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const eliminarUsuario = async (id_usuario) => {
    ...
    try {
      const res = await fetch(`https://proyectobackend-production-f34d.up.railway.app/web/usuarios/${id_usuario}`, {
        method: "DELETE",
      });
      const data = await res.json();
